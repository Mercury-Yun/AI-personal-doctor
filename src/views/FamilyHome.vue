  ...
  <section class="family-home">
    ...
    <div class="fh-card">
      <div class="fh-card-head">
        <strong>今日用药</strong>
        <RouterLink to="/family/medications" class="head-link">全部</RouterLink>
      </div>
...
const features = [
  { icon: '📁', label: '健康档案', to: '/family/profiles', tone: 'blue' },
  { icon: '📋', label: '病例管理', to: '/family/records', tone: 'green' },
  { icon: '⏰', label: '提醒管理', to: '/family/medications', tone: 'purple' },
]
