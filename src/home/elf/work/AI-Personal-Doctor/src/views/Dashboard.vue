...
import { prepareDemoForCapture, stopAllTts, syncVoiceSessionBusy } from '../utils/voiceSession'
...
const goPhotoVerify = async () => {
  ...
  try {
    ...
    await pauseWakeListening(180)
    await stopAllTts(15000)
    await cancelWakeSession()
