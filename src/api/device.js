...
export const wakeSession = (config = {}) =>
  request.post('/device/wake/session', {}, { timeout: 600000, ...config })

export const cancelWakeSession = () => request.post('/device/wake/cancel', {})

export const resetWakeSession = () => request.post('/device/wake/reset', {}, { timeout: 15000 })
...
export const startPhotoMode = (seconds = 180) =>
  request.post('/device/photo/mode/start', { seconds, interrupt: true }, { timeout: 15000 })

export const stopPhotoMode = () =>
  request.post('/device/photo/mode/stop', {}, { timeout: 10000 })

export const resetCameraCapture = () =>
  request.post('/device/camera/reset', {}, { timeout: 15000 })

export const capturePhoto = (config = {}) =>
  request.post('/device/camera/capture', {}, { timeout: 80000, ...config })

export const getCameraPreviewUrl = () => `/api/device/camera/last/image?t=${Date.now()}`

export const getCameraStreamUrl = () => `/api/device/camera/stream`

export const startCameraStream = () =>
  request.post('/device/camera/stream/start', {}, { timeout: 15000 })

export const stopCameraStream = () =>
  request.post('/device/camera/stream/stop', {}, { timeout: 15000 })

export const sendSOS = () => request.post('/device/sos', {}, { timeout: 15000 })
